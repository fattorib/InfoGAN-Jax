...
def create_latents_with_codes(num_noise, num_cts, num_cat, rng_key, num_samples):
    ...
    c = jax.random.categorical(key = rng_key, logits = jnp.array(logit_probs), shape =  (num_samples, num_cat))
...
if __name__ == '__main__':
    ...
    z = create_latents_with_codes(num_noise=62, num_cts=2, num_cat=10, rng_key = rng, num_samples=128)
